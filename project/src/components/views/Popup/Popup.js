...
export default (props) => {
  const {actions, popup} = props

  return (
    <div id="mypopup" style={{display: popup ? 'block' : 'none'}}>
      ...
      <button type="button" id="buttonexit" onclick={actions.toggle_visibility}> Fermer le pop-up </button>
    </div>
  )
}
